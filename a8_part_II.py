...
def get_planet_radius(planet_name: str) -> str:
    ...
    try:
        ...
        return match.group(1)  # Ensure you are returning the correct group that contains the radius
    except AttributeError:
        return error_text  # Returning the error message or a default value like 'Data not available'
...
def get_birth_date(name: str) -> str:
    ...
    if match:
        return match.group("birth")  # Accessing the named group "birth"
    else:
        return error_text  # Return this error message if no match is found
